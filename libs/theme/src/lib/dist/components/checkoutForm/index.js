...
class CheckoutForm extends React.Component {
  ...
  render() {
    ...
    if (cart && cart.items.length > 0) {
      ...
      }, /*#__PURE__*/React.createElement(CheckoutStepContacts, {
        isReadOnly: step > 1,
        step: step,
      ...
      }), /*#__PURE__*/React.createElement(CheckoutStepShipping, {
        show: step >= 2,
        step: step,
        isReadOnly: step > 2,
        title: text.shipping,
      ...
      }), showPaymentForm && /*#__PURE__*/React.createElement(CheckoutStepPayment, {
        show: step === 3,
        step: step,
        title: text.payment,
        inputClassName: checkoutInputClass,
      ...
      return /*#__PURE__*/React.createElement("p", null, text.emptyCheckout);
    }
  }
