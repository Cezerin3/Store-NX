...
class HeadMenuItem extends React.Component {
  ...
  render() {
    ...
    const items = categories.filter(item => item.parent_id === category.id).map((subcategory, index) => /*#__PURE__*/React.createElement(HeadMenuItem, {
      key: index,
    ...
    return /*#__PURE__*/React.createElement("li", {
      ...
      to: category.path,
      onClick: onClick
    }, category.name), hasItems && isMobile && /*#__PURE__*/React.createElement("span", {
      onClick: this.isActiveToggle
    })), hasItems && /*#__PURE__*/React.createElement("ul", {
...
class HeadMenu extends React.PureComponent {
  render() {
    ...
    const items = menuItems.filter(category => category.parent_id === null).map((category, index) => /*#__PURE__*/React.createElement(HeadMenuItem, {
      key: index,
      category: category,
      onClick: onClick,
      categories: categories,
