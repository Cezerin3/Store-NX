...
class Register extends React.Component {
  ...
  render() {
    ...
    }, text.register_title), !registerProperties.status && !registerProperties.isCustomerSaved && registerProperties.isCustomerSaved !== null && registerProperties.isRightToken ? /*#__PURE__*/React.createElement("p", {
      className: errorAlertText
    }, text.registry_failed) : "", registerProperties.status ? /*#__PURE__*/React.createElement("p", {
      className: successAlertText
    }, text.registry_doi_success) : "", registerProperties.isCustomerSaved ? /*#__PURE__*/React.createElement("p", {
      className: successAlertText
    }, text.registry_completed) : "", !registerProperties.isRightToken && registerProperties.isRightToken !== null ? /*#__PURE__*/React.createElement("p", {
      className: errorAlertText
    }, text.registry_wrong_token) : "", !registerProperties.isCustomerSaved && /*#__PURE__*/React.createElement(Field, {
    ...
    }), !registerProperties.isCustomerSaved && /*#__PURE__*/React.createElement(Field, {
      className: inputClassName,
      name: "last_name",
    ...
    }, !registerProperties.isCustomerSaved && /*#__PURE__*/React.createElement("button", {
      type: "submit",
      className: registerButtonClassName,
      disabled: registerProperties !== undefined && registerProperties.status
    }, text.register), registerProperties.isCustomerSaved && /*#__PURE__*/React.createElement(Link, {
      to: "/login",
      style: {
        textDecoration: "none"
      },
